...
class ServiceInforPage extends StatefulWidget {
  final UserModel user;
  final List<OBMModel> obms;
  final ServiceController controller;

  const ServiceInforPage({
    Key? key,
  ...
  @override
  State<ServiceInforPage> createState() => _ServiceInforPageState();
}

class _ServiceInforPageState extends State<ServiceInforPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Observer(builder: (context) {
            return Visibility(
                visible: (controller.obm.cias.isNotEmpty),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const SizedBox(
