...
class _CarDetailsPageState extends State<CarDetailsPage> {
  ...
  void initState() {
    ...
    rec = autorun((_) {
      setState(() {
        car = controller.cars.firstWhere((e) => e.id == widget.carId);
      });
    });
  }
  ...
  kmChangeWidget({required Function(String value) onUpdate}) => Form(
        key: _key,
        child: AlertDialog(
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(car.km, style: title.copyWith(fontWeight: FontWeight.bold)),
                                    ],
                                  ),
                                ],
                              )),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                car.proxOleo.isEmpty ? " --- " : car.proxOleo,
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                car.proxArref.isEmpty ? " --- " : car.proxArref,
                                style: title.copyWith(fontWeight: FontWeight.bold),
                              ),
                            ],
                          ),
...
class StatusWidget extends StatefulWidget {
  ...
  const StatusWidget({Key? key, required this.onInsert, required this.user}) : super(key: key);
